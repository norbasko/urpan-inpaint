...
def write_sequence_manifest(manifest: SequenceManifest) -> None:
    ...
    with frames_csv_path.open("w", newline="", encoding="utf-8") as handle:
        fieldnames = list(manifest.rows[0].to_manifest_row().keys()) if manifest.rows else [
            ...
            "roof_mask_source",
            "roof_mask_area_px",
            "roof_mask_temporal_disagreement",
            "roof_mask_error",
            "sky_mask_status",
            "sky_mask_source",
            "sky_mask_area_px",
            ...
            "dynamic_mask_status",
            "dynamic_mask_source",
            "dynamic_mask_area_px",
            "dynamic_mask_error",
            "inpaint_mask_status",
            "inpaint_mask_area_px",
            "inpaint_mask_error",
            "mask_fusion_status",
            "mask_fusion_error",
            "propainter_model_id",
            "propainter_output_dir",
            "propainter_window_count",
            "propainter_chunk_count",
            "propainter_status",
            "propainter_error",
            "lama_model_id",
            "lama_output_dir",
